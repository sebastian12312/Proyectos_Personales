...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/DisenoWebUsuario/Tienda.css">
    </head>
    <%
        //Datos Usuarios
    ...
    <body>
                ...
                <div class="contenedor_header_1">
                    ...
                    <div class="opciones_header">
                        <ul class="ul_opciones_header">
                            ...
                            <li><a href="carrito.jsp">carrito ${CantidadCarrito}</a></li>
        ...
        <%
            ...
            ArrayList<Productos> ListarProducto = new ArrayList<Productos>();
            ListarProducto = funciontienda.ListarTienda();
        %>
        <!-- Tienda -->
            ...
            <div class="contenedor_tienda">
                <%
                    for (int i = 0; i < ListarProducto.size(); i++) {
                        Productos p = ListarProducto.get(i);
                %>
                <div class="card_tienda">
                    ...
                    <div class="datos_card_tienda">
                        ...
                        <div>
                            <p><%=p.getCodigoProducto()%></p>
                        </div>
                    </div>
                    <div class="btn_tienda">
                        <a href="AgregarProducto?codigo=<%=p.getCodigoProducto()%>">ADD</a>
                    </div>
                </div>
                <%
                    }
