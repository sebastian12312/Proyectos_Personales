...
<html lang="en">
    ...
    <body>
        ...
        <!-- CATEGORIAS -->
        <div class="categorias_web">
            <a href="#" class="titulo_categorias_web">Categorias</a>
        ...
        <div class="cuerpo_oferta">
            <a href="#" class="titulo_oferta">Productos En Ofertas</a>
