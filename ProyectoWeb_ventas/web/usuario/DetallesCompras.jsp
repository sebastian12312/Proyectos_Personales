    ...
    <body>
        ...
        <%
            if (CodigoUsuario != null) {
                ...
                ArrayList<DetallesCompras> ListaDetalles = new ArrayList<DetallesCompras>();
                ListaDetalles = funcionesCompras.DetallesCompras(codigoCompra);
        %>
                    ...
                    <table class="table_dashboard">
                        ...
                        <%
                            ...
                            for (int i = 0; i < ListaDetalles.size(); i++) {
                                DetallesCompras detalles = ListaDetalles.get(i);
                                contadorDetalles++;
                        %>
                        <tr>
                            <td><%=contadorDetalles%></td>
                            <td><%=detalles.getCodigoCompra()%></td>
                            <td><%=detalles.getCodigoProducto()%></td>
                            <td><%=detalles.getNombreProducto()%></td>
                            <td><%=detalles.getDescripcionProducto()%></td>
                            <td><%=detalles.getCantidadCompra()%></td>
                            <td><%=detalles.getPrecioProducto()%></td>
                            <td><%=detalles.getSubTotal()%></td>
                            <td><%=detalles.getDescripcionProducto()%></td>
                            <td>
                                <a href="../usuario/MisCompras.jsp" class="detalles_compras"><i class="fa fa-file-o"></i></a>
                            </td>
                        </tr>
